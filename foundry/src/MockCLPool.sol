...
/// @title MockCLPool
/// @notice Minimal concentrated liquidity pool with linearised tick math,
///         sufficient to exhibit the geometric residual at order of
///         magnitude. Shared by copy from the Master Equation suite, which
///         owns the upstream; here it is the parent of MockCLPoolV2, the
///         exact-arithmetic predictor the fork suite compares against.
contract MockCLPool {
